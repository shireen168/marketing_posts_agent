...
class MarketingPostsCrew():
    ...
    def copy_creation_task(self) -> Task:
        return Task(
            ...
            output_file='marketing_copies.md'
        )

    @task
    def creative_overview_task(self) -> Task:
        return Task(
            config=self.tasks_config['creative_overview_task'],
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            verbose=2,
            # process=Process.hierarchical, # Uncomment if needed
        )